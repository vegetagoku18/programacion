...
public static File seleccionarRutaExistente() {
    ...
    public static void main(String[] args) {
        ...
        int opcion = 0;
        while (opcion != 5) {
            System.out.println("¿Qué opción quieres hacer?");// TODO repite ultima opción si hay error
            ...
            switch (opcion) {
                case 1:// TODO Control de rutas válidas. Mnostrar solo archivos si es directorio.
                ...
                case 2:
                    ...
                    try (Scanner f = new Scanner(archivo);) {// TODO try-with-resources. Y control de excepciones.
                        while (f.hasNext()) {
                    ...
                    break;
                case 3:
                    archivo = seleccionarArchivoValido();// TODO no repetir codigo
                    System.out.println("¿Qué texto quieres añadir al archivo?");
                    sc.nextLine();
                    String texto = sc.nextLine();
                    try (PrintWriter pw = new PrintWriter(new FileWriter(archivo, true))){// TODO try-with-resources.
                    ...
                    break;
                case 4:// TODO confirmar si borra. Solo pregunta si existe.
                    archivo = seleccionarArchivoValido();
